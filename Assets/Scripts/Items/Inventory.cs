...
namespace Items
{
    public class Inventory : MonoBehaviour
    {
        ...
        private readonly Dictionary<string, InventoryData> _items = new();
        ...
        public Dictionary<string, InventoryData> Items => _items;
        ...
        public void AddItem(SimpleItem.ItemData item)
        {
            ...
            {
                _items.Add(item.name, new InventoryData {Item = item, Quantity = 1});
            }
        }
